...
import { MedicationMonitoringDialog2 } from "@/components/dashboard/medication-monitoring-dialog-2";

export default function Education2Page() {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      console.log("[DEBUG] Completing education-2 for user:", user.id);

      // Mark education-2 as completed
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Edukasi 2</CardTitle>
            <CardDescription>
              Kenali Hambatan Minum Obat dan Cara Mengatasinya
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted rounded-lg overflow-hidden space-y-4">
              <div className="aspect-video flex items-center justify-center relative bg-black/5">
                ...
                >
                  <source src="https://ofspsbgrglzongrcmtpg.supabase.co/storage/v1/object/public/education-videos/edukasi2.mp4" type="video/mp4" />
            ...
            <div className="space-y-4">
              <div className="bg-muted/50 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                  <li>Apakah Anda pernah lupa minum obat?</li>
                  <li>Sengaja Tidak Minum Obat</li>
                  <li>Berhenti Saat Merasa Sehat</li>
                  <li>Berhenti Karena Tidak Nyaman</li>
                  <li>Kesulitan Minum Obat</li>
                </ul>
              </div>
            </div>
