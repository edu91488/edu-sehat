...
export default function AdminLoginPage() {
  ...
  const ADMIN_EMAIL = process.env.NEXT_PUBLIC_ADMIN_EMAIL || "admin@edusehat.com";
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="admin@edusehat.com"
                  value={email}
            ...
            <div className="mt-6 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-xs text-blue-700">
                Email: <code className="bg-white px-1 rounded">admin@edusehat.com</code>
              </p>
              <p className="text-xs text-blue-700">
